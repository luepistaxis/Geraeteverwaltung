...
# Datenbank Verbuebersicht_geraete_
...
class UebersichtGeraete(tk.Frame):
    ...
    def open_uebersicht_geraete(self):
        def toggle_frame():
            if uebersicht_geraete_frame.winfo_ismapped():
                uebersicht_geraete_frame.pack_forget()
                self.open_uebersicht_geraete()

            else:
                uebersicht_geraete_frame.pack()
        ...
        uebersicht_geraete_frame = tk.Frame(self.parent, bg="white")
        ...
        tree = ttk.Treeview(uebersicht_geraete_frame)
        scrollbar = tk.Scrollbar(uebersicht_geraete_frame, orient="vertical", command=tree.yview)
